...
public class WorkingCapitalLoanCOBFilterHelperImpl extends COBFilterApiMatcher implements WorkingCapitalLoanCOBFilterHelper {
    ...
    public void executeInlineCob(List<Long> loanIds) {
        retryConfigurationAssembler.getRetryConfigurationForExecuteCommand().executeRunnable(() -> inlineLoanCOBExecutorService
                .execute(loanIds, WorkingCapitalLoanCOBConstant.INLINE_WORKING_CAPITAL_LOAN_COB_JOB_NAME));
    }
