...
class WorkingCapitalLoanRecoveryPaymentWriteServiceTest {
    ...
    void undoRecoveryPaymentRestoresTotalRecoveredAndPublishesSpecificAndGenericEvents() {
        ...
        assertThat(events.get(0)).isInstanceOf(WorkingCapitalLoanUndoRecoveryPaymentTransactionBusinessEvent.class);
        assertThat(events.get(1)).isInstanceOf(WorkingCapitalLoanTransactionReversedBusinessEvent.class);
    }
