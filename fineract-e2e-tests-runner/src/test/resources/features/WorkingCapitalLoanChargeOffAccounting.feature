...
# --- Charge-off: the full unreleased discount (1000 - 9.61 = 990.39) moves to charge-off expense in one shot ---
  ...
  @TestRailId:C99203
  Scenario: Verify Working Capital charge-off accounting: undo charge-off with discount fee reverses journal entries - UС48
    Given Admin sets the business date to "01 January 2026"
    And Admin creates a client with random data and creates-approves-disburses a working capital loan with the following data:
      | LoanProduct         | submittedOnDate | expectedDisbursementDate | principalAmount | totalPayment | periodPaymentRate | discount |
...
# --- Undo charge-off ---
  ...
  @TestRailId:C98204
  Scenario: Verify Working Capital charge-off accounting: undo charge-off with discount fee reverses journal entries with fraud expense - UС49
    Given Admin sets the business date to "01 January 2026"
    And Admin creates a client with random data and creates-approves-disburses a working capital loan with the following data:
      | LoanProduct         | submittedOnDate | expectedDisbursementDate | principalAmount | totalPayment | periodPaymentRate | discount |
      | WCLP_ACC_DEF_REV_AM | 01 January 2026 | 01 January 2026          | 9000            | 100000       | 18                | 1000     |
...
# catch them up.
  ...
  # TODO: generate testrail id
  Scenario: Verify Working Capital charge-off accounting - UC52: backdated full repayment before charge-off with an active discount pool lifts charge-off and reverses the final discount fee amortization
    Given Admin sets the business date to "01 January 2026"
    And Admin creates a client with random data and creates-approves-disburses a working capital loan with the following data:
      | LoanProduct         | submittedOnDate | expectedDisbursementDate | principalAmount | totalPayment | periodPaymentRate | discount |
      | WCLP_ACC_DEF_REV_AM | 01 January 2026 | 01 January 2026          | 9000            | 100000       | 18                | 1000     |
